...
**Acknowledgments:** The code implementation of this project references [xiaotudui](https://github.com/xiaotudui/tudui-object-detection-model)'s YOLO tutorial (MIT License). Special thanks to the original author.
